...
rm src/no/jjohansen/master/R.java 

#Now use aapt
echo Create the R.java file
aapt p -f -v -M AndroidManifest.xml -F ./build/resources.res -I ~/system/classes/android.jar -S res/ -J src/no/jjohansen/master
...
javac -verbose -cp ../libs/demolib.jar -d ../build/classes no/jjohansen/master/MainActivity.java 
...
dx --dex --verbose --no-strict --output=../demo_android.dex no ../../libs/demolib.jar
